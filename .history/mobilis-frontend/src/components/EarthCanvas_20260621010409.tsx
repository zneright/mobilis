...
export const EarthCanvas = () => {
    ...
    useEffect(() => {
        ...
        const initThree = () => {
            ...
            tCtx.font = "40px Arial, Helvetica, sans-serif"; // Reduced font size to fit the emoji perfectly
    ...
    return (
        ...
        >
            ...
            />
            {/* Removed the rounded-full and overflow-hidden classes here so the 3D scene doesn't get chopped! */}
            <div
                ref={mountRef}
