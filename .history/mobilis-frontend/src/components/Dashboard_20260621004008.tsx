    ...
    const handleRequestAdvance = async () => {
        ...
        try {
            ...
            if (status === "SUCCESS") {
                ...
                throw new Error("Transaction failed during network execution.");
            }

        } catch (error) {
            console.error("Soroban Invocation Error:", error);
            alert("Failed to process advance. Ensure the TODA Treasury has USDC and you do not have an active loan.");
        } finally {
