...
export const EarthCanvas = () => {
    ...
    useEffect(() => {
        ...
        const initThree = () => {
            ...
            tCtx.shadowBlur = 20;
            tCtx.fillStyle = "rgba(16,185,129,0.15)";
            tCtx.beginPath();
            tCtx.arc(128, 128, 90, 0, Math.PI * 2);
            tCtx.fill();
            ...
            // Reset shadow for crisp drawing
            tCtx.shadowBlur = 0;
            ...
            tCtx.beginPath();
            tCtx.roundRect(cx - 45, cy - 20, 90, 40, 6);
            tCtx.fill();

            // Jeepney hood/front (slanted)
            tCtx.beginPath();
            tCtx.moveTo(cx + 45, cy - 15);
            tCtx.lineTo(cx + 60, cy - 5);
            tCtx.lineTo(cx + 60, cy + 15);
            tCtx.lineTo(cx + 45, cy + 20);
            tCtx.closePath();
            tCtx.fill();

            // Roof
            tCtx.fillStyle = "#0d9668";
            tCtx.beginPath();
            tCtx.roundRect(cx - 40, cy - 35, 75, 18, 4);
            tCtx.fill();
            ...
            for (let i = 0; i < 4; i++) {
                tCtx.beginPath();
                tCtx.roundRect(cx - 38 + i * 20, cy - 15, 14, 18, 2);
                tCtx.fill();
            }

            // Front windshield
            tCtx.beginPath();
            tCtx.roundRect(cx + 47, cy - 10, 10, 18, 2);
            tCtx.fill();

            // Wheels
            tCtx.fillStyle = "#1f2937";
            tCtx.beginPath();
            tCtx.arc(cx - 28, cy + 25, 12, 0, Math.PI * 2);
            tCtx.fill();
            tCtx.beginPath();
            tCtx.arc(cx + 35, cy + 25, 12, 0, Math.PI * 2);
            tCtx.fill();

            // Wheel hubcaps
            tCtx.fillStyle = "#9ca3af";
            tCtx.beginPath();
            tCtx.arc(cx - 28, cy + 25, 5, 0, Math.PI * 2);
            tCtx.fill();
            tCtx.beginPath();
            tCtx.arc(cx + 35, cy + 25, 5, 0, Math.PI * 2);
            tCtx.fill();

            // Headlight
            tCtx.fillStyle = "#fbbf24";
            tCtx.beginPath();
            tCtx.arc(cx + 57, cy + 8, 4, 0, Math.PI * 2);
            tCtx.fill();

            // Decorative stripes on body
            tCtx.strokeStyle = "#fbbf24";
            tCtx.lineWidth = 2;
            tCtx.beginPath();
            tCtx.moveTo(cx - 45, cy + 5);
            tCtx.lineTo(cx + 45, cy + 5);
            tCtx.stroke();
            ...
            tokenSprite.scale.set(0.5, 0.5, 1);
